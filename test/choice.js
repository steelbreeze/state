...
choice.to(stateA).effect(trigger => trigger.data.path1++);
choice.to(stateA).effect(trigger => trigger.data.path2++);
choice.to(stateA).effect(trigger => trigger.data.path3++);
