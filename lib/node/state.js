...
var Vertex = /** @class */ (function (_super) {
    ...
    function Vertex(name, parent) {
        var _this = _super.call(this, name, parent instanceof Region ? parent : parent.defaultRegion() || new Region(Region.defaultName, parent)) || this;
...
var State = /** @class */ (function (_super) {
    ...
    State.prototype.defaultRegion = function () {
        return this.children.find(function (region) { return region.name === Region.defaultName; });
    };
