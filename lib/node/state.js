...
var Container = (function () {
     ...
     */
    Container.prototype.defaultRegion = function () {
     ...
     * @return Returns true if the [region]{@link Region} is complete.
     */
    Container.prototype.isComplete = function (instance) {
...
var Transition = (function () {
    ...
    function Transition(source, target, kind) {
        ...
        this.guard = source instanceof PseudoState ? function () { return true; } : function (instance, message) { return message === _this.source; }; // TODO: zero index
...
var Runtime = (function (_super) {
    ...
    Runtime.prototype.visitElement = function (element, deepHistoryAbove) {
        this.getActions(element).leave = delegate_1.create(this.getActions(element).leave, function (instance) { return console.log(instance + " leave " + element); });
        this.getActions(element).beginEnter = delegate_1.create(this.getActions(element).beginEnter, function (instance) { return console.log(instance + " enter " + element); });
    };
    ...
    Runtime.findElse = function (pseudoState) {
        return pseudoState.outgoing.filter(function (transition) { return transition.isElse(); })[0]; // TODO: zero index
    };
    ...
    Runtime.evaluate = function (state, instance) {
        ...
        if (state instanceof State) {
            if (result) {
                ...
                if (transitions.length === 1) {
                    Runtime.traverse.apply(Runtime, [transitions[0], instance].concat(message)); // TODO: zero index
                    result = true;
                }
