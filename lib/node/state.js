...
var State = /** @class */ (function (_super) {
    ...
    State.prototype.defaultRegion = function () {
        return this.children.find(function (region) { return region.name === Region_1.Region.defaultName; });
    };
...
var StateMachine = /** @class */ (function () {
    ...
    StateMachine.prototype.initialise = function (instance) {
        if (instance) {
            ...
            logger_1.logger.log("initialise " + instance);
            this.onInitialise(instance, false);
        }
        else {
            logger_1.logger.log("initialise " + this);
    ...
    StateMachine.prototype.evaluate = function (instance) {
        ...
        logger_1.logger.log(instance + " evaluate message: " + message);
...
var Transition = /** @class */ (function () {
    ...
    Transition.internalTransitionsTriggerCompletion = false;
...
var Runtime = /** @class */ (function (_super) {
    ...
    Runtime.prototype.visitElement = function (element) {
        this.getActions(element).leave = delegate_1.create(this.getActions(element).leave, function (instance) { return logger_1.logger.log(instance + " leave " + element); });
        this.getActions(element).beginEnter = delegate_1.create(this.getActions(element).beginEnter, function (instance) { return logger_1.logger.log(instance + " enter " + element); });
    };
    Runtime.prototype.visitRegion = function (region, deepHistoryAbove) {
        ...
        if (deepHistoryAbove || !regionInitial || PseudoStateKind_1.PseudoStateKind.isHistory(regionInitial.kind)) {
            this.getActions(region).endEnter = delegate_1.create(this.getActions(region).endEnter, function (instance, deepHistory) {
                ...
                var actions = _this.getActions((deepHistory || (regionInitial && PseudoStateKind_1.PseudoStateKind.isHistory(regionInitial.kind))) ? instance.getLastKnownState(region) || regionInitial : regionInitial);
                var history = deepHistory || (regionInitial && regionInitial.kind === PseudoStateKind_1.PseudoStateKind.DeepHistory);
    ...
    Runtime.prototype.visitExternalTransition = function (transition) {
        ...
        if (sourceAncestors[i] instanceof Region_1.Region) {
            i += 1;
        }
    ...
    Runtime.selectTransition = function (pseudoState, instance) {
        ...
        if (transitions.length > 1) {
            logger_1.logger.error("Multiple outbound transition guards returned true at " + pseudoState + " for " + message);
        }
        ...
        if (state instanceof State) {
            if (result) {
                ...
                if (transitions.length === 1) {
                    ...
                    logger_1.logger.error(state + ": multiple outbound transitions evaluated true for message " + message);
                }
            }
        }
        return result;
