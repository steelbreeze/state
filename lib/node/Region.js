 ...
 * @hidden
 */
    doEnter(transaction, deepHistory, trigger, cascade, next) {
        ...
        if (cascade) {
            ...
            if (starting) {
                starting.doEnter(transaction, this.history(deepHistory, _1.PseudoStateKind.DeepHistory), trigger, true, undefined);
            }
            else {
