...
var NamedElement = /** @class */ (function () {
     ...
     * @hidden
     */
    NamedElement.prototype.doEnter = function (instance, history, trigger) {
     ...
     * @hidden
     */
    NamedElement.prototype.doEnterHead = function (instance, history, trigger, next) {
        var _this = this;
        _1.log.write(function () { return instance + " enter " + _this; }, _1.log.Entry);
    };
    /**
     ...
     * @hidden
     */
    NamedElement.prototype.doExit = function (instance, history, trigger) {
        var _this = this;
        _1.log.write(function () { return instance + " leave " + _this; }, _1.log.Exit);
    };
    /**
