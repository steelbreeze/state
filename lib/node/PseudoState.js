 ...
 */
class PseudoState extends Vertex_1.Vertex {
    /**
    ...
    getTransition(trigger) {
        const transition = this.kind & _1.PseudoStateKind.Choice ? (0, random_1.random)(this.outgoing.filter(transition => transition.evaluate(trigger))) : super.getTransition(trigger);
