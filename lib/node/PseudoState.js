...
var PseudoState = /** @class */ (function (_super) {
    ...
    PseudoState.prototype.getTransition = function (trigger) {
        var result = (this.kind === PseudoStateKind_1.PseudoStateKind.Choice ? this.getChoiceTransition(trigger) : _super.prototype.getTransition.call(this, trigger)) || this.elseTransition;
        if (!result) {
    ...
    PseudoState.prototype.getChoiceTransition = function (trigger) {
        ...
        return results[util_1.random.get(results.length)];
    };
