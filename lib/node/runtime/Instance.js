...
var Instance = /** @class */ (function () {
    ...
    Instance.prototype.evaluate = function (trigger) {
        ...
        return this.transaction(function () {
            var deferred = _this.dirtyEventPool;
            _this.dirtyEventPool = [];
            ...
            if (result) {
                var _loop_1 = function (i) {
                    util_1.log.info(function () { return _this + " evaluate " + deferred[i]; }, util_1.log.Evaluate);
                    runtime_1.evaluate(_this.root, _this, false, deferred[i]);
                };
                ...
                _this.dirtyEventPool = deferred.reverse().concat(_this.dirtyEventPool);
            }
            return result;
        });
    };
    ...
    Instance.prototype.defer = function (trigger) {
        ...
        if (this.dirtyEventPool.indexOf(trigger) === -1) {
            util_1.log.info(function () { return _this + " defer " + trigger; }, util_1.log.Evaluate);
    ...
    Instance.prototype.transaction = function (operation) {
        try {
            ...
            this.cleanEventPool = this.dirtyEventPool.filter(function (event) { return event; });
    ...
    Instance.prototype.stateFromJSON = function (state, jsonState) {
        var _loop_2 = function (jsonRegion) {
    ...
    Instance.prototype.regionFromJSON = function (region, jsonRegion) {
        var _loop_3 = function (jsonState) {
