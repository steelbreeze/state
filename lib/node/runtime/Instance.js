...
var Instance = /** @class */ (function () {
    ...
    Instance.prototype.evaluate = function (trigger) {
        ...
        return this.transaction(function () {
            ...
            if (result) {
                ...
                while (_this.playDefered(_this.dirtyEventPool.length)) { }
            }
            return result;
        });
    };
     ...
     * @internal
     */
    Instance.prototype.playDefered = function (deferred) {
        for (var i = 0; i < deferred; i++) {
            if (this.dirtyEventPool[i] && runtime_1.evaluate(this.root, this, false, this.dirtyEventPool[i])) {
