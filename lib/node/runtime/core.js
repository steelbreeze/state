...
model.ExternalTransitionActivation.prototype.exitSource = function (instance, deepHistory, trigger) {
    // exit the element below the common ancestor
    this.toExit.leave(instance, deepHistory, trigger);
};
model.ExternalTransitionActivation.prototype.enterTarget = function (instance, deepHistory, trigger) {
    // enter elements below the common ancestor to the target
...
model.LocalTransitionActivation.prototype.exitSource = function (instance, deepHistory, trigger) {
...
model.LocalTransitionActivation.prototype.enterTarget = function (instance, deepHistory, trigger) {
    if (this.vertexToEnter && !isActive(this.vertexToEnter, instance)) {
        this.vertexToEnter.enter(instance, deepHistory, trigger);
    }
};
model.InternalTransitionActivation.prototype.exitSource = function (instance, deepHistory, trigger) {
    // don't exit anything
};
model.InternalTransitionActivation.prototype.enterTarget = function (instance, deepHistory, trigger) {
