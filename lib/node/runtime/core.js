...
function evaluate(instance, trigger) {
    util_1.log.info(function () { return instance + " evaluate trigger: " + trigger; }, util_1.log.Evaluate);
    instance.beginTran();
 ...
 * @internal
 */
function traverse(vertex, instance, deepHistory, trigger) {
...
model.PseudoState.prototype.getTransition = function (trigger) {
    ...
    // choice pseudo states may have multiple outbound transitions evaluate true in which case a random one is selected
        ...
        result = transitions[util_1.random.get(transitions.length)];
    }
...
model.PseudoState.prototype.enterTail = function (instance, deepHistory, trigger) {
    ...
    if (this.kind !== model.PseudoStateKind.Junction) {
        util_1.log.info(function () { return instance + " testing completion transitions from " + _this; }, util_1.log.Evaluate);
...
model.State.prototype.completion = function (instance, deepHistory, trigger) {
    ...
    util_1.log.info(function () { return instance + " testing completion transitions at " + _this; }, util_1.log.Evaluate);
