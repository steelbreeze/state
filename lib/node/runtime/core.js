...
model.PseudoState.prototype.getTransition = function (trigger) {
    var result = (this.kind === model.PseudoStateKind.Choice ? this.getChoiceTransition(trigger) : model.State.prototype.getTransition.call(this, trigger)) || this.elseTransition;
    if (!result) {
        throw new Error("Unable to find transition at " + this + " for " + trigger);
    }
    return result;
};
model.PseudoState.prototype.getChoiceTransition = function (trigger) {
    var transitions = [];
