...
var PseudoState = /** @class */ (function () {
    ...
    PseudoState.prototype.to = function (target) {
        return new Transition_1.Transition(this, target, TransitionKind_1.TransitionKind.external);
    };
    /**
    ...
    PseudoState.prototype["else"] = function (target) {
        ...
        return this.elseTransition = new Transition_1.Transition(this, target, TransitionKind_1.TransitionKind.external).when(function () { return false; });
    };
