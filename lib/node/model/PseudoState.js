...
var PseudoState = /** @class */ (function () {
    ...
    function PseudoState(name, parent, kind) {
        ...
        if (this.kind === PseudoStateKind_1.PseudoStateKind.Initial || this.isHistory()) {
            util_1.log.assert(!this.parent.starting, function () { return "Only one initial pseudo state is allowed in region " + _this.parent; });
    ...
    PseudoState.prototype["else"] = function (target) {
        var _this = this;
        util_1.log.assert(!this.elseTransition, function () { return "Only 1 else transition allowed at " + _this + "."; });
