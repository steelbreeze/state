...
var LocalTransition = /** @class */ (function (_super) {
    ...
    function LocalTransition(source, target) {
        ...
        var to = targetAncestors.length - (target instanceof PseudoState_1.PseudoState && target.kind & PseudoStateKind_1.History ? 1 : 0); // NOTE: if the target is a history pseudo state we just enter the parent region and it's history logic will come into play
