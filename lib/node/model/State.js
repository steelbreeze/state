...
var State = /** @class */ (function () {
    ...
    function State(name, parent) {
        ...
        if (this.parent) {
            util_1.assert.empty(this.parent.children.filter(function (vertex) { return vertex.name === name; }), function () { return "State names must be unique within their parent region"; });
