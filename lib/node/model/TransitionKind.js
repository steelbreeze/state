...
var TransitionPath_1 = require("./TransitionPath");
/**
 ...
 * @internal
 */
var ExternalTransitionKind = /** @class */ (function () {
    function ExternalTransitionKind() {
    }
    /**
     ...
     */
    ExternalTransitionKind.prototype.getPath = function (source, target) {
        ...
        return new TransitionPath_1.TransitionPath(this, sourceAncestors[from], targetAncestors.slice(from, to).reverse());
    };
    ExternalTransitionKind.prototype.toString = function () {
        return "external";
    };
 ...
 * @internal
 */
var InternalTransitionKind = /** @class */ (function () {
    function InternalTransitionKind() {
    }
    /**
     ...
     * @returns Returns the path of element to exit and enter when traversing the transition.
     */
    InternalTransitionKind.prototype.getPath = function (source, target) {
        return new TransitionPath_1.TransitionPath(this);
    };
    InternalTransitionKind.prototype.toString = function () {
        return "internal";
    };
 ...
 * @internal
 */
var LocalTransitionKind = /** @class */ (function () {
    function LocalTransitionKind() {
    }
    /**
     ...
     * @returns Returns the path of element to exit and enter when traversing the transition.
     */
    LocalTransitionKind.prototype.getPath = function (source, target) {
        ...
        var to = targetAncestors.length - (target instanceof PseudoState_1.PseudoState && target.isHistory() ? 1 : 0); // NOTE: if the target is a history pseudo state we just enter the parent region and it's history logic will come into play
        // initialise the base class with source, target and elements to exit and enter
        return new TransitionPath_1.TransitionPath(this, targetAncestors[from], targetAncestors.slice(from, to).reverse());
    };
    LocalTransitionKind.prototype.toString = function () {
        return "local";
    };
    return LocalTransitionKind;
}());
...
(function (TransitionKind) {
     ...
     * If the source or target vertices are not leaf-level elements within the state machine hierarchy, the exit or entry operation will cascate to child elements as needed.
     */
    TransitionKind.external = new ExternalTransitionKind();
    /**
     * An internal transition does not cause a change of state; when traversed it only executes the user defined transition behaviour.
     */
    TransitionKind.internal = new InternalTransitionKind();
    /**
     * A local transition is one where either the source or target is the common ancestor of both vertices.
     * Traversal is the same as an external transition but the common ancestor is not entered/exited.
     */
    TransitionKind.local = new LocalTransitionKind();
