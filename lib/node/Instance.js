...
var Instance = /** @class */ (function () {
    ...
    function Instance(name, root) {
        ...
        this.transactional(function (transaction) { return _this.root.doEnter(transaction, false, _this.root); }, new Transaction_1.Transaction(this)); // enter the root element
    }
    /**
    ...
    Instance.prototype.transactional = function (operation, transaction) {
        try {
            ...
            for (var k = Object.keys(transaction.lastKnownState), i = k.length; i--;) {
