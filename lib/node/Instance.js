...
var Instance = /** @class */ (function () {
    ...
    function Instance(name, root) {
        ...
        this.transaction(function (transaction) { return _this.root.doEnter(transaction, false, _this.root); }, new Transaction_1.Transaction(this)); // enter the root element
    }
    /**
    ...
    Instance.prototype.evaluate = function (trigger) {
        ...
        return this.transaction(function (transaction) {
            ...
            return result;
        }, new Transaction_1.Transaction(this));
    };
    /**
     ...
     */
    Instance.prototype.transaction = function (operation, tx) {
        try {
            return operation(tx);
        }
        finally {
            for (var k = Object.keys(tx.dirtyState), i = 0, l = k.length; i < l; ++i) {
