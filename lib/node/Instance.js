...
var Instance = /** @class */ (function () {
    ...
    Instance.prototype.evaluateDeferred = function () {
        ...
        var _loop_1 = function (i, l) {
            ...
            if (trigger && this_1.root.getDeferrableTriggers(this_1).indexOf(trigger.constructor) === -1) { // TODO: revalidate logic
        ...
        var this_1 = this;
        for (var i = 0, l = this.deferredEventPool.length; i < l; ++i) {
