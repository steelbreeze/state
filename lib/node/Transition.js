...
class Transition {
    ...
    constructor(source) {
        ...
        this.target = source;
        this.strategy = new InternalTransitionStrategy_1.InternalTransitionStrategy(this.source, this.target);
    ...
    to(target, kind = _1.TransitionKind.External) {
        ...
        else if (kind === _1.TransitionKind.Local) {
            this.strategy = new LocalTransitionStrategy_1.LocalTransitionStrategy(this.source, this.target);
        }
        return this;
    }
    /**
     ...
     * @hidden
     */
    traverse(transaction, history, trigger) {
        var transition = this;
     ...
     * @hidden
     */
    execute(transaction, history, trigger) {
