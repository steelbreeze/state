...
var Transition = /** @class */ (function () {
    ...
    function Transition(source, target, kind, type, guard) {
        ...
        if (kind === void 0) { kind = (target ? index_1.TransitionKind.external : index_1.TransitionKind.internal); }
        ...
        this.activation = new index_1.TransitionKind.map[kind](this.source, this.target);
    ...
    Transition.prototype.traverse = function (instance, deepHistory, trigger) {
        ...
        while (transition.target instanceof index_1.PseudoState && transition.target.kind === index_1.PseudoStateKind.Junction) {
        ...
        var _loop_1 = function (i) {
            ...
            for (var j = transitions[i].onTraverse.length; j--;) {
