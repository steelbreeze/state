...
var State = /** @class */ (function (_super) {
    ...
    function State(name, parent) {
        ...
        if (_this.parent) {
            util_1.assert.ok(!_this.parent.children.filter(function (vertex) { return vertex instanceof State && vertex.name === _this.name; }).length, function () { return "State names must be unique within a region"; });
    ...
    State.prototype.enterHead = function (instance, deepHistory, trigger, nextElement) {
        ...
        _super.prototype.enterHead.call(this, instance, deepHistory, trigger, nextElement);
    ...
    State.prototype.evaluate = function (instance, deepHistory, trigger) {
        var result = this.delegate(instance, deepHistory, trigger) || this.accept(instance, deepHistory, trigger) || this.doDefer(instance, trigger);
    ...
    State.prototype.doDefer = function (instance, trigger) {
        var result = false;
