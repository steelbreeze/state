...
var State = /** @class */ (function (_super) {
    ...
    State.prototype.defer = function () {
        ...
        var _a;
        (_a = this.deferrableTrigger).push.apply(_a, __spread(type));
        return this;
    };
    ...
    State.prototype.evaluate = function (instance, history, trigger) {
        var result = this.delegate(instance, history, trigger) || _super.prototype.evaluate.call(this, instance, history, trigger) || this.doDefer(instance, trigger);
        if (result) {
    ...
    State.prototype.getDeferred = function (instance) {
        return this.children.reduce(function (result, region) { return result.concat(instance.getState(region).getDeferred(instance)); }, this.deferrableTrigger);
    };
