...
2. An interface, and default implementation of that interface, to represent an instance of a state machine model, which embodies the *active state configuration*, thereby enabling multiple instances adhering to the same state machine model. 
