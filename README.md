...
> **Notes:**
>
>v7.0.0 is in the works and contains significant breaking changes but offers considerable performance improvements. As a major release it contains breaking changes, see the [release notes](RELEASES.md) for more information.
>
